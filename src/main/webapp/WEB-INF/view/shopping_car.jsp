...
<body>
        ...
        <div class="row">
            ...
            <div class="col-sm-10  col-md-10 col-sm-offset-1 col-md-offset-1">
                ...
                <div class="row">
                    ...
                    <button type="button" class="btn btn-danger btn-lg col-lg-2 col-md-2 col-sm-2"
    ...
    <script type="text/javascript">
        ...
        function exit()
        {
            window.location.href = "${cp}/exitCar";
        }
        ...
        function updateShoppingCars()
        {
            ...
            for (var i = 0; i < allShoppingCars.length; i++)
            {
                ...
                html += '<tr>' +
                        ...
                        '<div class="checkbox">' +
                        '<label>' +
                        '<input type="checkbox" id="checkbox' + allShoppingCars[i].productId + '" value="option1" checked="checked">' +
                        '</label>' +
                        '</div>' +
                        '</td>' +
                        '<td>' + product.name + '</td>' +
