...
<body>
    ...
    <div class="container-fluid">
        <h1 class="title center">注册</h1><br/>
            ...
            <div class="form-horizontal">
                <div class="form-group">
                    ...
                    <div class="col-sm-6 col-md-6">
                        <input type="text" class="form-control" id="inputUserName" placeholder="请输入（必填）"/>
                    </div>
                </div>
                <%--<div class="form-group">--%>
                ...
                <div class="form-group">
                    ...
                    <div class="col-sm-6 col-md-6">
                        <input type="text" class="form-control" id="inputNickname" placeholder="默认与用户名一致（可选）"/>
                    </div>
                </div>
                <div class="form-group">
                    <label for="inputPassword" class="col-sm-2 col-md-2 control-label">密码</label>
                    <div class="col-sm-6 col-md-6">
                        <input type="password" class="form-control" id="inputPassword" placeholder="请输入（必填）"/>
                    </div>
                </div>
                <div class="form-group">
                    <label for="inputPhoneNumber" class="col-sm-2 col-md-2 control-label">手机号码</label>
                    <div class="col-sm-6 col-md-6">
                        <input type="text" class="form-control" id="inputPhoneNumber" placeholder="请输入手机号（可选）"/>
                    </div>
                </div>
                <%--<div class="form-group">--%>
...
//            else if (registerResult == 'phoneNumberExist')
//            {
//                layer.close(loading);
//                layer.msg('这个电话号码已经注册啦！', {icon: 2});
//            }
