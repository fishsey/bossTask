...
<body>
        ...
        <div class="row margin-t">
            <div class="form-horizontal">
                ...
                <div class="form-group form-group-lg col-sm-6 col-md-6">
                    <input type="text" class="form-control" id="newSearchKeyWord" placeholder="真武世界" onkeypress="if (event.keyCode == 13) searchPre();" />
                </div>
    ...
    <script type="text/javascript">
        ...
        function updateList(searchKeyWord)
        {
            ...
            {
                var imgURL = "${cp}/img/" + searchResult[i].picPath + ".jpg";
