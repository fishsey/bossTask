...
<html lang="zh-CN">
  <head>
      ...
      <script src="${cp}/js/JavaScript-MD5-master/js/md5.min.js"></script>
  </head>
  <body>
            ...
            <div  class="form-horizontal">
                <div class="form-group">
                    ...
                    <div class="col-sm-6 col-md-6">
                        <input type="text" class="form-control" id="inputUserName" placeholder="xxxxxx"/>
                    </div>
                </div>
                <div class="form-group">
    ...
    <script type="text/javascript">
        function startLogin() {
            ...
            user.password = md5(document.getElementById("inputPassword").value);
            $.ajax({
                async : false,
                type : 'POST',
                url : '${cp}/doLogin',
